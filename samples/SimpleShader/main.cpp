...
int main()
{
        ...
        Surface *cube = StandartSurfaces::Grid(100,100,256,256,false);
        Entity *body = s->Add(cube);

		Shader *simple = eng->LoadShader(L"../../../../samples/media/simpleshader");
		simple->Compile();

		body->SetShader(simple);
